...
SWIFT_CLASS("_TtC10AppBoxoSDK21AppBoxoViewController")
...
@interface AppBoxoViewController (SWIFT_EXTENSION(AppBoxoSDK)) <WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
